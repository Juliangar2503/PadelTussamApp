...
object MatchTable : Table("matches"){
    ...
    val scoreSet1A = integer("scoreSet1A").nullable()
    val scoreSet1B = integer("scoreSet1B").nullable()
    val scoreSet2A = integer("scoreSet2A").nullable()
    val scoreSet2B = integer("scoreSet2B").nullable()
    val scoreSet3A = integer("scoreSet3A").nullable()
    val scoreSet3B = integer("scoreSet3B").nullable()
